...
if(isset($_SERVER['HTTP_REFERER'])) {
    ...
    if (strpos($referer, home_url()) !== false) {
        ...
        require_once(plugin_dir_path( __FILE__ ) . '/builder_support.php');
        ...
        <head>
            ...
            <title><?php echo get_option('redirect_page_title'); ?></title>
            <?php wp_head(); ?>
            <style id="redirectpage_custom_style"><?php echo get_option('redirectpage_custom_styles'); ?></style>
            <style>
            *{ margin: 0px; padding: 0px; box-sizing: border-box;}
            body{ background: <?php echo get_option('redirect_page_bg_color'); ?>;}
